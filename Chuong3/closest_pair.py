...
def main():
	P = [
	    Point(x=2, y=3), Point(x=12, y=30), Point(x=40, y=50),
	    Point(x=5, y=1), Point(x=12, y=10), Point(x=3, y=4),
	    Point(x=7, y=2), Point(x=4, y=10), Point(x=5, y=4),
	    Point(x=6, y=3), Point(x=11, y=5), Point(x=3, y=8)
    ]
	n = len(P)
